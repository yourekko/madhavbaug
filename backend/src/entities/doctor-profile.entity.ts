...
export class DoctorProfile {
  ...
  @Column({ name: 'branch_name', type: 'varchar', nullable: true, length: 180 })
  branchName!: string | null;

  @Column({ name: 'profile_link', type: 'varchar', nullable: true, length: 500 })
  profileLink!: string | null;

  @Column({ name: 'whatsapp_number', type: 'varchar', nullable: true, length: 20 })
  whatsappNumber!: string | null;

  @Column({ name: 'expertise_tags', type: 'simple-json', nullable: true })
  expertiseTags!: string[] | null;

  @Column({ name: 'profile_completed', default: true })
